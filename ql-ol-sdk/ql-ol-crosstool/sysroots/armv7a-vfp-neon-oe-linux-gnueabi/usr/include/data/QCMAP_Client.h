...
/** @ingroup qcmap_set_wlan_config
  ...
  @param[out] qmi_err_num             Error code returned by the server.
  @param[optional] guest_profile       Data Structure pointer to set guest APs\n
                                                  profile info. Must be used only when \n
                                                  more than Guest AP's are configured.
...
/*===========================================================================
FUNCTION AddEthernetModule()
===========================================================================*/
/** @ingroup AddEthernetModule
