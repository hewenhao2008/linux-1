...
#define QMI_ATCOP_MAX_MSG_SIZE           1024 
...
typedef enum
{
  QMI_ATCOP_URC_PORT_INVALID = 0xff,
  QMI_ATCOP_URC_PORT_ALL = 0,
  QMI_ATCOP_URC_PORT_UART1 = 1,
  QMI_ATCOP_URC_PORT_USBAT = 2,
  QMI_ATCOP_URC_PORT_USBMODEM = 3
}qmi_atcop_urc_port_type;
 //quectel add end 
...
typedef struct
{
  ...
  //quectel add start
  qmi_atcop_urc_port_type             urc_port;  
  //quectel add end   
