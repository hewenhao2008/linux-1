...
#  $Header: //components/rel/boot.bf/3.1.2/boot_images/core/storage/tools/nandbootmbn/nand_mbn_generator.py#2 $
#  $DateTime: 2015/09/27 23:27:02 $ 
#  $Author: pwbldsvc $
...
def ParseToCreateOutputFiles(filename, block_size_in_kb, page_size_in_kb, total_page_count):
    ...
    for element in iter:
        ...
        if element.tag=="partition":
            ...
            user_partition_entries.append({"label":"","size_in_kb":0,"padding_in_kb":0,"filename":"","attr":0,"which_flash":0,"num_partition_sectors":0,"start_sector":0})           ## make room for it
