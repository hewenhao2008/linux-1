...
typedef enum {
    ...
    MULTILINE_RSP,   /* multiple line intermediate response
                    only first line starting with a prefix */
} ATCommandType;
...
/*
    used for single line cmd, such as "AT+CGMM"
*/
...
/*
    used for single line cmd, started with number such as "AT+GSN"
*/
int at_send_command_numeric (const char *command,
                                 ATResponse **pp_outResponse);

/*
    used for multi line cmd
*/
...
/*
    used for single line cmd, response multi-line, such as "AT+CMGR"
*/
int at_send_command_single_cmd_resp_multiline (const char *command,
                                const char *responsePrefix,
                                 ATResponse **pp_outResponse);
