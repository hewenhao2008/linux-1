...
static int msm_auxpcm_dev_probe(struct platform_device *pdev)
{
	...
	pr_err("\n%s,%d --------- %d----------------\n", __FUNCTION__, __LINE__, auxpcm_pdata->mode_16k.pcm_clk_rate);
