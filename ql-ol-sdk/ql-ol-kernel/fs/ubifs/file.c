...
dump:
	ubifs_err(c, "bad data node (block %u, inode %lu)",
		...
		{
			printk("@Ramos erase usr_data partitino flag here 33331111\r\n");
		...
		if( 1 == c->vi.ubi_num)
		{
			...
			Quectel_Set_Partition_RestoreFlag("modem", 3);
		}
#endif
		...
		//ռ˳Linuxsystemʱ ubi 0 һ£modem ubi سҲ
			printk("@Ramos set restore systemfs flag here 33331111\r\n");
			Quectel_Set_Partition_RestoreFlag("system",3);
		}
#endif
