...
{
	int ret;
#ifdef CONFIG_QUECTEL_MODEM_BOOT_TIME
...
#ifdef CONFIG_QUECTEL_MODEM_BOOT_TIME //jun20160728
    pr_notice("@RamosKernel command line: %s\n", temp_cmdLine);
    //if(strstr(temp_cmdLine, "ubi.mtd=18")) this condition will replace last,
    {
      /* µķsystemΪ18 system132+1 flashmodemʾģеģʽrecovery ģʽmodem
        ͬģܲͬsystem15 ӷͬʱҪм޸ֵ
        */
