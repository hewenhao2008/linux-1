					    ...
					    struct ubi_ainf_volume *av)
{
	...
	if (!leb_corrupted[0]) {
		...
		if(1 == ubi->ubi_num)
		{
			...
			Quectel_Set_Partition_RestoreFlag("modem",7);
		}
#endif
	...
	//ռ˳Linuxsystemʱ ubi 0 һ£modem ubi سҲ
			printk("@Ramos set restore systemfs flag here 7771111 \r\n");
			Quectel_Set_Partition_RestoreFlag("system",7);
		}
#endif
		...
		{
		//ռ˳Linuxsystemʱ ubi 0 һ£modem ubi سҲ
			printk("@Ramos set restore systemfs flag here 77722222 \r\n");
			Quectel_Set_Partition_RestoreFlag("system",7);
		}
#endif
